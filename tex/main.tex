...
\usepackage{titling}
\title{2019 Competitive Programming I}
...
\fancypagestyle{document}
{
	...
	\fancyhead[R]{National Chiao Tung University\\[1mm]2019 Competitive Programming I Final\vspace{1mm}}
    \fancyfoot[C]{\thepage}
}
\pagestyle{document}
...
{
	\stepcounter{ncase}
	\IfFileExists{#1/\arabic{ncase}.input.txt}
    {
		\vspace{-3mm}
		\begin{paracol}{2}
			\subsection*{Sample Input \arabic{ncase}}
			\lstinputlisting{#1/\arabic{ncase}.input.txt}
			\switchcolumn
			\subsection*{Sample Output \arabic{ncase}}
			\lstinputlisting{#1/\arabic{ncase}.output.txt}
		\end{paracol}
		\testdata{#1}
    }{}
}
...
%\tableofcontents
\problem{A}{A Towering Problem}{1}{256}
\problem{B}{B is The Easiest}{1}{256}
\problem{C}{Coloring Socks}{1}{256}
\problem{D}{Dolls}{2}{256}
\problem{E}{Exhausted \texttt{mangojunior}}{2}{256}
\problem{F}{Fortune}{1}{256}
\problem{G}{Greatness of Subarrays}{4}{256}
\problem{H}{Hank's Challenge}{1}{256}
\end{document}
