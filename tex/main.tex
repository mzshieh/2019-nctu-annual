...
\usepackage{titling}
\title{2019 NCTU Annual Programming Contest}
...
\fancypagestyle{document}
{
	...
	\fancyhead[R]{National Chiao Tung University\\[1mm]2019 Annual Programming Contest\vspace{1mm}}
    \fancyfoot[C]{\thepage}
}
\pagestyle{document}
...
%\tableofcontents
%\vspace*{8mm}
\problem{A}{A Chair Problem}{1}{256}
\problem{B}{Both Chairs}{1}{256}
\problem{C}{Chairs}{1}{256}
\problem{D}{Temperature Difference}{10}{256}
\problem{E}{P-adic Equation}{1}{256}
\problem{F}{Forming Number}{1}{256}
\problem{G}{Geometric Center}{1}{256}
\problem{H}{Construct DAG}{1}{256}
\problem{I}{Ideal Triangle}{1}{256}
\problem{J}{Joyful Path}{1}{256}
\problem{K}{Ideal Triangle Checker}{1}{256}
\problem{L}{Run Length}{1}{256}
